export default (
  ...
  projectTitle: string,
  projectLink: string
): string => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE]><html xmlns="http://www.w3.org/1999/xhtml" class="ie"><![endif]--><!--[if !IE]><!--><html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]--><head>
...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #f0f0f0;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;font-family: avenir,sans-serif;text-align: center;"><span class="font-avenir"><span style="text-align:left"><strong>Hi ${name}!</strong></span></span></h1><h1 class="size-18" style="Margin-top: 20px;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #565656;font-size: 17px;line-height: 26px;font-family: avenir,sans-serif;text-align: center;" lang="x-size-18"><span class="font-avenir"><span style="color:rgb(120, 119, 120); text-align:left">${sharerName} wants you to collab on <strong>${projectTitle}</strong>&nbsp;</span></span></h1>
      </div>
    </div>
      ...
      <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #5032e8;font-family: Ubuntu, sans-serif;" href="${projectLink}">GO TO PROJECT</a><![endif]>
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${projectLink}" style="width:158px" arcsize="9%" fillcolor="#5032E8" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,11px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Ubuntu,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">GO TO PROJECT</center></v:textbox></v:roundrect><![endif]--></div>
    </div>
